...
- Worktree: `dirty` (16 changed paths)
...
- Raw context: `expected=...xt><ellipse cx="70.7056" cy="14" fill="#FFFFFF" rx="8" ry="8" style="stroke:#000... actual=...xt><ellipse cx="70.7056" cy="14" fill="#E2E2F0" rx="8" ry="8" style="stroke:#181...`
- Semantic first diff: target=`reference` at `1:2407`
- Semantic context: `expected=...xt><ellipse cx="70.7056" cy="14" fill="#FFFFFF" rx="8" ry="8" style="stroke:#000... actual=...xt><ellipse cx="70.7056" cy="14" fill="#E2E2F0" rx="8" ry="8" style="stroke:#181...`
...
- Actual object: `{'tag': 'ellipse', 'attrs': {'cx': '70.7056', 'cy': '14', 'fill': '#E2E2F0', 'rx': '8', 'ry': '8', 'style': 'stroke:#181818;stroke-width:1;'}}`
...
thread 'reference_fixtures_dev_jaws_jaws6_puml' (4102020) panicked at tests/reference_tests.rs:226:9:
...
actual:   ...xt><ellipse cx="70.7056" cy="14" fill="#E2E2F0" rx="8" ry="8" style="stroke:#181...
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws6-after-title-fix/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws6-after-title-fix/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws6-after-title-fix/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws6-after-title-fix/rust-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws6-after-title-fix/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws6-after-title-fix/reference-test.stderr.log`
