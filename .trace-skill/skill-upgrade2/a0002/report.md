...
- Status: `passed`
- Return code: `0`
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/reference-test.stdout.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/java-render.stderr.log`
- reference_test: returncode=0
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/skill-upgrade2/a0002/reference-test.stderr.log`
