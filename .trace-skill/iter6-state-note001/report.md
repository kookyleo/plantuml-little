...
thread 'reference_fixtures_state_state_note001_puml' (4136826) panicked at tests/reference_tests.rs:226:9:
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-note001/reference-test.stderr.log`
