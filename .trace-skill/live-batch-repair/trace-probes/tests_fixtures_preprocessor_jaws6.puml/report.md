# Diagnosis Report: tests/fixtures/preprocessor/jaws6.puml

## Case

- Fixture: `/ext/plantuml/plantuml-little/tests/fixtures/preprocessor/jaws6.puml`
- Reference test: `reference_fixtures_preprocessor_jaws6_puml`
- Family: `sequence`
...
thread 'reference_fixtures_preprocessor_jaws6_puml' (4098345) panicked at tests/reference_tests.rs:226:9:
tests/fixtures/preprocessor/jaws6.puml: output differs from reference at line 1 col 839
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-repair/trace-probes/tests_fixtures_preprocessor_jaws6.puml/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-repair/trace-probes/tests_fixtures_preprocessor_jaws6.puml/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-repair/trace-probes/tests_fixtures_preprocessor_jaws6.puml/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-repair/trace-probes/tests_fixtures_preprocessor_jaws6.puml/rust-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-repair/trace-probes/tests_fixtures_preprocessor_jaws6.puml/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-repair/trace-probes/tests_fixtures_preprocessor_jaws6.puml/reference-test.stderr.log`
