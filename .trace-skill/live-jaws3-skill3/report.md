...
thread 'reference_fixtures_dev_jaws_jaws3_puml' (4006498) panicked at tests/reference_tests.rs:226:9:
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-jaws3-skill3/reference-test.stderr.log`
