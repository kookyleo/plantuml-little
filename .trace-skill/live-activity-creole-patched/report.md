...
- rust: viewport={'width': '158px', 'height': '273px'} elements={'rect': 3, 'path': 0, 'text': 14, 'ellipse': 0, 'polygon': 2, 'group': 1}
...
- Target: `reference`
- Line/col: `1:149`
- Context: `expected=...s" data-diagram-type="ACTIVITY" height="301px" preserveAspectRatio="none" style=... actual=...s" data-diagram-type="ACTIVITY" height="273px" preserveAspectRatio="none" style=...`

## Diff Classification

- Surface category: `coordinate-only`
- Viewport delta: `dw=+4, dh=-28`
- First coordinate signal: `x2 +3.8145`
...
thread 'reference_fixtures_activity_activity_creole_table_02_puml' (4023632) panicked at tests/reference_tests.rs:226:9:
...
actual:   ...s" data-diagram-type="ACTIVITY" height="273px" preserveAspectRatio="none" style=...
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-activity-creole-patched/reference-test.stderr.log`
