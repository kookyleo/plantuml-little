...
- rust: viewport={'width': '385px', 'height': '368px'} elements={'rect': 3, 'path': 8, 'text': 6, 'ellipse': 2, 'polygon': 3, 'group': 10}
...
thread 'reference_fixtures_state_state_note001_puml' (4132021) panicked at tests/reference_tests.rs:226:9:
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-iter5/reference-test.stderr.log`
