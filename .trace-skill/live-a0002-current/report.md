...
thread 'reference_fixtures_activity_a0002_puml' (4054610) panicked at tests/reference_tests.rs:219:21:
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-a0002-current/reference-test.stderr.log`
