...
thread 'reference_fixtures_state_state_note001_puml' (4108912) panicked at tests/reference_tests.rs:226:9:
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-skill4/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-skill4/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-skill4/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-skill4/rust-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-skill4/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-skill4/reference-test.stderr.log`
