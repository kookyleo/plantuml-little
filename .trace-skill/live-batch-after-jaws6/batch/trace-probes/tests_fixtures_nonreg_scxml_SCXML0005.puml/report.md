# Diagnosis Report: tests/fixtures/nonreg/scxml/SCXML0005.puml

## Case

- Fixture: `/ext/plantuml/plantuml-little/tests/fixtures/nonreg/scxml/SCXML0005.puml`
- Reference test: `reference_fixtures_nonreg_scxml_SCXML0005_puml`
...
thread 'reference_fixtures_nonreg_scxml_SCXML0005_puml' (4108637) panicked at tests/reference_tests.rs:226:9:
tests/fixtures/nonreg/scxml/SCXML0005.puml: output differs from reference at line 1 col 147
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-after-jaws6/batch/trace-probes/tests_fixtures_nonreg_scxml_SCXML0005.puml/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-after-jaws6/batch/trace-probes/tests_fixtures_nonreg_scxml_SCXML0005.puml/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-after-jaws6/batch/trace-probes/tests_fixtures_nonreg_scxml_SCXML0005.puml/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-after-jaws6/batch/trace-probes/tests_fixtures_nonreg_scxml_SCXML0005.puml/rust-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-after-jaws6/batch/trace-probes/tests_fixtures_nonreg_scxml_SCXML0005.puml/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-batch-after-jaws6/batch/trace-probes/tests_fixtures_nonreg_scxml_SCXML0005.puml/reference-test.stderr.log`
