...
- rust: viewport={'width': '240px', 'height': '450px'} elements={'rect': 4, 'path': 7, 'text': 5, 'ellipse': 2, 'polygon': 6, 'group': 12}
...
- Raw context: `expected=...css" data-diagram-type="STATE" height="404px" preserveAspectRatio="none" style="... actual=...css" data-diagram-type="STATE" height="450px" preserveAspectRatio="none" style="...`
- Semantic first diff: target=`reference` at `1:147`
- Semantic context: `expected=...css" data-diagram-type="STATE" height="404px" preserveAspectRatio="none" style="... actual=...css" data-diagram-type="STATE" height="450px" preserveAspectRatio="none" style="...`
...
- Actual object: `{'tag': 'svg', 'attrs': {'contentStyleType': 'text/css', 'data-diagram-type': 'STATE', 'height': '450px', 'preserveAspectRatio': 'none', 'style': 'width:240px;height:450px;background:#FFFFFF;', 'version': '1.1', 'viewBox': '0 0 240 450', 'width': '240px', 'zoomAndPan': 'magnify'}, 'text': 'ActiveIdleProcessingPausedH'}`

## Diff Classification

- Surface category: `coordinate-only`
- Viewport delta: `dw=+30, dh=+46`
...
thread 'reference_fixtures_state_state_history001_puml' (4136831) panicked at tests/reference_tests.rs:226:9:
...
actual:   ...css" data-diagram-type="STATE" height="450px" preserveAspectRatio="none" style="...
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/iter6-state-history001/reference-test.stderr.log`
