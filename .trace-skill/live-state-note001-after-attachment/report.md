...
- rust: viewport={'width': '386px', 'height': '368px'} elements={'rect': 3, 'path': 7, 'text': 6, 'ellipse': 2, 'polygon': 2, 'group': 9}
...
- Actual object: `{'tag': 'svg', 'attrs': {'contentStyleType': 'text/css', 'data-diagram-type': 'STATE', 'height': '368px', 'preserveAspectRatio': 'none', 'style': 'width:386px;height:368px;background:#FFFFFF;', 'version': '1.1', 'viewBox': '0 0 386 368', 'width': '386px', 'zoomAndPan': 'magnify'}, 'text': 'ActiveRunningInactive\n\nThis is active\n\nMulti linenote text'}`

## Diff Classification

- Surface category: `coordinate-only`
- Viewport delta: `dw=+15, dh=+2`
...
thread 'reference_fixtures_state_state_note001_puml' (4119345) panicked at tests/reference_tests.rs:226:9:
...
```
- Primary log: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/reference-test.stderr.log`
...
- rust_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/rust.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/rust-render.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/rust-render.stderr.log`
- java_render: returncode=0
  artifact: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/java.svg`
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/java-render.stdout.svg`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/java-render.stderr.log`
- reference_test: returncode=101
  stdout: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/reference-test.stdout.log`
  stderr: `/ext/plantuml/plantuml-little/.trace-skill/live-state-note001-after-attachment/reference-test.stderr.log`
